...
* The original package name 'de.affenbande.reloaded.raid-applicants-distributor' is invalid and this project uses 'de.affenbande.reloaded.raidapplicantsdistributor' instead.
